...
def public_feed():
    ...
    # MEDIA SCREEN IS MEDIA-ONLY: never show text-only news/updates here.
...
<style>
.public-media-hero{position:relative;overflow:hidden;margin:0 calc(50% - 50vw) 10px;border-radius:0;padding:24px 18px;background:#080d14;color:#fff;min-height:76vh;display:flex;align-items:flex-end}
.public-media-hero h1{font-size:30px;margin:0 0 5px}.public-media-hero p{margin:0;opacity:.92;font-size:13px}.public-media-hero:before{content:'MEDIA ONLY';position:absolute;top:18px;left:18px;font-size:11px;font-weight:900;letter-spacing:.12em;padding:7px 10px;border:1px solid rgba(255,255,255,.28);border-radius:999px;background:rgba(0,0,0,.28)}
...
.public-composer{position:sticky;top:42px;z-index:20}.public-composer textarea{min-height:82px}.public-media-preview{width:100%;height:min(88vh,900px);object-fit:contain;border-radius:0;display:block;margin-top:9px;background:#05080d}.public-video-preview{aspect-ratio:auto;max-height:none;object-fit:contain}.public-post{padding:0;margin:0 calc(50% - 50vw) 14px;border-radius:0;overflow:hidden;background:#05080d}.public-post .public-post-head,.public-post .public-post-body,.public-post .public-actions,.public-post form,.public-post>h2,.public-post>div:not(.public-media-preview){margin-left:auto;margin-right:auto;max-width:820px}.public-post .public-post-head{padding:12px 12px 0;color:#fff}.public-post .public-post-body{padding:10px 12px;color:#fff}.public-post .public-actions{padding:0 12px 12px}.public-post .public-avatar{background:#1d2a3a;color:#fff}.public-post .small{color:rgba(255,255,255,.7)}
...
@media(max-width:760px){.public-composer{top:38px}.public-media-hero{border-radius:0;padding:18px 14px;min-height:72vh}.public-media-hero h1{font-size:25px}.public-post{border-radius:12px}.public-media-preview{max-height:430px}}
</style>
<section class="public-media-hero"><div><h1>🎥 KOJA Media</h1><p>Full-screen photos, videos, marketing media and live calls.</p></div></section>
...
def public_feed_create():
    ...
    if post_type in {'media','marketing'} and not uploaded:
        flash('Media posts require a photo or video.','danger'); return redirect(url_for('public_feed'))
