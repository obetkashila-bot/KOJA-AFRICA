...
<meta name="google-site-verification" content="u4nfIf5MfXm0iVvECSQeYAov4Tz4601ayY5kYzNc4ko">
<title>KOJA AFRICA | Academic Questions, Assignments &amp; Research Support</title>
<meta name="description" content="KOJA AFRICA is a knowledge platform for academic questions, assignments, research support, documents, learning resources and professional services.">
<meta name="robots" content="index,follow,max-image-preview:large,max-snippet:-1,max-video-preview:-1">
<meta name="googlebot" content="index,follow,max-image-preview:large,max-snippet:-1,max-video-preview:-1">
<link rel="canonical" href="https://koja-africa.onrender.com/">
<meta property="og:type" content="website">
<meta property="og:site_name" content="KOJA AFRICA">
<meta property="og:title" content="KOJA AFRICA | Academic Questions, Assignments &amp; Research Support">
<meta property="og:description" content="Academic assignments, research documents, professional services and live delivery support from KOJA AFRICA.">
<meta property="og:url" content="https://koja-africa.onrender.com/">
<meta name="twitter:card" content="summary">
<meta name="twitter:title" content="KOJA AFRICA | Academic Questions, Assignments &amp; Research Support">
<meta name="twitter:description" content="Academic assignments, research documents, professional services and live delivery support.">
<script type="application/ld+json">{"@context":"https://schema.org","@type":"Organization","name":"KOJA AFRICA","url":"https://koja-africa.onrender.com/","description":"Knowledge platform for academic questions, assignments, research documents, professional services and delivery support."}</script>
<script type="application/ld+json">{"@context":"https://schema.org","@type":"WebSite","name":"KOJA AFRICA","url":"https://koja-africa.onrender.com/"}</script>
<style>
*{box-sizing:border-box}html{scroll-behavior:smooth}body{margin:0;font-family:Arial,Helvetica,sans-serif;background:#f8fafc;color:#172033;line-height:1.6}a{color:inherit}.skip{position:absolute;left:-9999px}.skip:focus{left:12px;top:12px;background:#fff;padding:10px;z-index:99}.site-header{background:#0f172a;color:#fff}.nav{max-width:1180px;margin:auto;padding:16px 20px;display:flex;gap:16px;align-items:center;flex-wrap:wrap}.brand{font-size:21px;font-weight:800;text-decoration:none;margin-right:auto}.nav a:not(.brand){text-decoration:none;opacity:.95}.hero{max-width:1180px;margin:0 auto;padding:72px 20px 68px}.hero h1{font-size:clamp(2.2rem,7vw,4.4rem);line-height:1.05;margin:0 0 18px;max-width:850px}.hero p{font-size:clamp(1.05rem,2.5vw,1.3rem);max-width:760px;color:#dbeafe}.actions{display:flex;gap:12px;flex-wrap:wrap;margin-top:26px}.btn{display:inline-block;background:#0f766e;color:#fff;text-decoration:none;border:0;border-radius:10px;padding:12px 18px;font-weight:700}.btn.secondary{background:#334155}.wrap{max-width:1180px;margin:auto;padding:42px 20px}.section-title{font-size:2rem;margin:0 0 10px}.intro{max-width:760px;color:#475569}.grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(240px,1fr));gap:18px;margin-top:24px}.card{background:#fff;border:1px solid #e2e8f0;border-radius:16px;padding:22px;box-shadow:0 8px 30px rgba(15,23,42,.06);transition:transform .18s ease,box-shadow .18s ease}.card:hover{transform:translateY(-3px);box-shadow:0 12px 34px rgba(15,23,42,.10)}.card h3{margin-top:0}.steps{counter-reset:step}.step{position:relative;padding-left:48px}.step:before{counter-increment:step;content:counter(step);position:absolute;left:0;top:0;width:32px;height:32px;border-radius:50%;display:grid;place-items:center;background:#0f766e;color:#fff;font-weight:800}.faq details{background:#fff;border:1px solid #e2e8f0;border-radius:12px;padding:14px 16px;margin:10px 0}.faq summary{font-weight:700;cursor:pointer}footer{background:#0f172a;color:#cbd5e1;padding:30px 20px;text-align:center}.sr-only{position:absolute;width:1px;height:1px;padding:0;margin:-1px;overflow:hidden;clip:rect(0,0,0,0);white-space:nowrap;border:0}@media(max-width:700px){.nav{gap:11px}.nav a:not(.brand){font-size:.92rem}.hero{padding-top:52px;padding-bottom:48px}.wrap{padding-top:30px}}@media(prefers-reduced-motion:reduce){html{scroll-behavior:auto}.card{transition:none}.card:hover{transform:none}}
</style>
</head>
<body>
...
<a class="brand" href="/">KOJA AFRICA</a>
<a href="/">Home</a><a href="/assignments">Assignments</a><a href="/documents">Documents</a><a href="/services">Services</a><a href="/delivery">Delivery</a>
{% if user %}<a href="/dashboard">Dashboard</a><a href="/logout">Logout</a>{% else %}<a href="/login">Login</a><a href="/register">Create Account</a>{% endif %}
<a href="/admin/login">Admin</a>
</nav>
<section class="hero">
<h1>Knowledge, questions, assignments and professional services in one place.</h1>
<p>KOJA AFRICA connects learners and customers with academic assignment support, research documents, professional services and live delivery services.</p>
<div class="actions">{% if user %}<a class="btn" href="/dashboard">Open Dashboard</a>{% else %}<a class="btn" href="/register">Create Account</a><a class="btn secondary" href="/login">Login</a>{% endif %}</div>
</section>
</header>
<main id="main" class="wrap">
<section aria-labelledby="services-title"><h2 id="services-title" class="section-title">KOJA AFRICA Services</h2><p class="intro">Explore the main public services available on KOJA AFRICA.</p>
<div class="grid">
<article class="card"><h3>Assignments &amp; Academic Questions</h3><p>Submit academic questions and assignments, upload supporting files, and receive administrator answers and answer documents.</p><a class="btn" href="/assignments">Open Assignments</a></article>
<article class="card"><h3>Documents &amp; Research</h3><p>Browse academic and research documents, search by title or subject, and access published learning resources.</p><a class="btn" href="/documents">Browse Documents</a></article>
<article class="card"><h3>Professional Services</h3><p>Find doctors and tutors, request professional services, and create a professional CV.</p><a class="btn" href="/services">Explore Services</a></article>
<article class="card"><h3>Drivers &amp; Live Delivery</h3><p>Request delivery services, discover online drivers and track an active delivery using live GPS updates.</p><a class="btn" href="/delivery">Open Delivery</a></article>
</div></section>
<section aria-labelledby="how-title" style="margin-top:58px"><h2 id="how-title" class="section-title">How KOJA AFRICA Works</h2><div class="grid steps">
<article class="card step"><h3>Choose a service</h3><p>Select assignments, documents, professional services or delivery.</p></article>
<article class="card step"><h3>Submit your request</h3><p>Provide the required information and upload supporting documents where needed.</p></article>
<article class="card step"><h3>Track your request</h3><p>Use your dashboard or the relevant service page to follow progress.</p></article>
</div></section>
<section aria-labelledby="about-title" style="margin-top:58px"><h2 id="about-title" class="section-title">About KOJA AFRICA</h2><p class="intro">KOJA AFRICA is a digital knowledge and services platform designed to make academic resources, professional support and delivery services easier to access.</p></section>
<section class="faq" aria-labelledby="faq-title" style="margin-top:58px"><h2 id="faq-title" class="section-title">Frequently Asked Questions</h2>
<details><summary>What can I use KOJA AFRICA for?</summary><p>You can use the platform for assignments and academic questions, documents and research resources, professional services, CV creation and delivery requests.</p></details>
<details><summary>Can I upload assignment or document files?</summary><p>Yes. Registered users can upload supported files through the relevant service pages.</p></details>
<details><summary>Can I track a delivery?</summary><p>Yes. Delivery tracking can show the current status and available driver location information for an active delivery.</p></details>
</section>
<section class="card" style="margin-top:40px;text-align:center"><h2>Ready to use KOJA AFRICA?</h2><p>Create an account to access personalized services and your dashboard.</p><a class="btn" href="/register">Get Started</a></section>
</main>
<footer><strong>KOJA AFRICA</strong><br>Knowledge • Questions • Answers • Documents • Professional Services • Delivery<br><small>© 2026 KOJA AFRICA</small></footer>
