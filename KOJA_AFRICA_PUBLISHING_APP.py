...
.brand{font-weight:900;font-size:19px;margin-right:auto;display:flex;align-items:center;gap:9px;letter-spacing:.2px;animation:logoPulse 3s ease-in-out infinite}
...
.menu-toggle{display:none;width:auto;margin:0;padding:8px 11px;background:rgba(255,255,255,.1);font-size:20px}
.drawer-overlay{display:none}
@media(max-width:850px){.menu-toggle{display:block}.nav-inner>a{display:none}.mobile-drawer{display:none;position:absolute;left:0;right:0;top:100%;background:#10233f;padding:10px 14px 16px;box-shadow:0 10px 22px rgba(0,0,0,.2)}.mobile-drawer.open{display:block}.mobile-drawer a{display:block;margin:4px 0;animation:drawerIn .25s ease both}.mobile-drawer a:nth-child(2){animation-delay:.03s}.mobile-drawer a:nth-child(3){animation-delay:.06s}.mobile-drawer a:nth-child(4){animation-delay:.09s}.mobile-drawer a:nth-child(5){animation-delay:.12s}.mobile-drawer a:nth-child(6){animation-delay:.15s}.drawer-overlay.open{display:block;position:fixed;inset:0;background:rgba(0,0,0,.28);z-index:900}}
