...
-- ============================================================
-- KOJA PROFIT ENGINE V1 ADDITIVE EXTENSION
-- ============================================================
...
-- KOJA MARKET LIVE SHOPPING V2
create table if not exists public.koja_market_live_rooms (
  id text primary key, seller_id uuid not null, title text not null default 'Live Shopping',
  status text not null default 'live', pinned_product_id uuid, started_at timestamptz not null default now(),
